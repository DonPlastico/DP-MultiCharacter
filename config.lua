...
Config.StartItemsList = { -- Items que se le darán al jugador al crear un personaje nuevo. Se pueden agregar más items, pero asegúrate de que existan entre tus items.
    {name = "water", amount = 5},
    {name = "bread", amount = 5},
    {name = "phone", amount = 1}
}
...
Config.Nationalities = { -- Nacionalidades disponibles para los personajes. Puedes agregar más nacionalidades, pero asegúrate de que tengan un código de país válido.
    { label = "Afganistán", id = "af" },
    { label = "Albania", id = "al" },
    { label = "Alemania", id = "de" },
    { label = "Andorra", id = "ad" },
    { label = "Angola", id = "ao" },
    { label = "Antigua y Barbuda", id = "ag" },
    ...
    { label = "Austria", id = "at" },
    { label = "Azerbaiyán", id = "az" },
    { label = "Bahamas", id = "bs" },
    { label = "Bangladés", id = "bd" },
    { label = "Barbados", id = "bb" },
    { label = "Baréin", id = "bh" },
    { label = "Bélgica", id = "be" },
    { label = "Belice", id = "bz" },
    { label = "Benín", id = "bj" },
    { label = "Bielorrusia", id = "by" },
    { label = "Birmania (Myanmar)", id = "mm" },
    { label = "Bolivia", id = "bo" },
    { label = "Bosnia y Herzegovina", id = "ba" },
    { label = "Botsuana", id = "bw" },
    { label = "Brasil", id = "br" },
    { label = "Brunéi", id = "bn" },
    ...
    { label = "China", id = "cn" },
    { label = "Chipre", id = "cy" },
    { label = "Ciudad del Vaticano", id = "va" },
    { label = "Colombia", id = "co" },
    { label = "Comoras", id = "km" },
    { label = "Corea del Norte", id = "kp" },
    { label = "Corea del Sur", id = "kr" },
    { label = "Costa de Marfil", id = "ci" },
    { label = "Costa Rica", id = "cr" },
    { label = "Croacia", id = "hr" },
    { label = "Cuba", id = "cu" },
    { label = "Dinamarca", id = "dk" },
    { label = "Dominica", id = "dm" },
    { label = "Ecuador", id = "ec" },
    { label = "Egipto", id = "eg" },
    { label = "El Salvador", id = "sv" },
    { label = "Emiratos Árabes Unidos", id = "ae" },
    { label = "Eritrea", id = "er" },
    { label = "Eslovaquia", id = "sk" },
    { label = "Eslovenia", id = "si" },
    { label = "España", id = "es" },
    { label = "Estados Unidos", id = "us" },
    { label = "Estonia", id = "ee" },
    { label = "Esuatini", id = "sz" },
    { label = "Etiopía", id = "et" },
    { label = "Filipinas", id = "ph" },
    ...
    { label = "Guinea", id = "gn" },
    { label = "Guinea-Bisáu", id = "gw" },
    { label = "Guinea Ecuatorial", id = "gq" },
    { label = "Guyana", id = "gy" },
    { label = "Haití", id = "ht" },
    ...
    { label = "Irán", id = "ir" },
    { label = "Irlanda", id = "ie" },
    { label = "Islandia", id = "is" },
    { label = "Islas Marshall", id = "mh" },
    { label = "Islas Salomón", id = "sb" },
    { label = "Israel", id = "il" },
    { label = "Italia", id = "it" },
    { label = "Jamaica", id = "jm" },
    { label = "Japón", id = "jp" },
    { label = "Jordania", id = "jo" },
    { label = "Kazajistán", id = "kz" },
    { label = "Kenia", id = "ke" },
    { label = "Kirguistán", id = "kg" },
    ...
    { label = "Luxemburgo", id = "lu" },
    { label = "Macedonia del Norte", id = "mk" },
    { label = "Madagascar", id = "mg" },
    { label = "Malasia", id = "my" },
    { label = "Malaui", id = "mw" },
    { label = "Maldivas", id = "mv" },
    { label = "Malí", id = "ml" },
    { label = "Malta", id = "mt" },
    { label = "Marruecos", id = "ma" },
    { label = "Mauricio", id = "mu" },
    ...
    { label = "Nigeria", id = "ng" },
    { label = "Noruega", id = "no" },
    { label = "Nueva Zelanda", id = "nz" },
    { label = "Omán", id = "om" },
    { label = "Países Bajos", id = "nl" },
    { label = "Pakistán", id = "pk" },
    { label = "Palaos", id = "pw" },
    { label = "Palestina", id = "ps" },
    { label = "Panamá", id = "pa" },
    { label = "Papúa Nueva Guinea", id = "pg" },
    { label = "Paraguay", id = "py" },
    { label = "Perú", id = "pe" },
    { label = "Polonia", id = "pl" },
    { label = "Portugal", id = "pt" },
    { label = "Reino Unido", id = "gb" },
    { label = "República Centroafricana", id = "cf" },
    { label = "República Checa", id = "cz" },
    { label = "República del Congo", id = "cg" },
    { label = "República Democrática del Congo", id = "cd" },
    { label = "República Dominicana", id = "do" },
    { label = "República Sudafricana", id = "za" },
    { label = "Ruanda", id = "rw" },
    { label = "Rumanía", id = "ro" },
    { label = "Rusia", id = "ru" },
    { label = "Samoa", id = "ws" },
    { label = "San Cristóbal y Nieves", id = "kn" },
    { label = "San Marino", id = "sm" },
    { label = "San Vicente y las Granadinas", id = "vc" },
    { label = "Santa Lucía", id = "lc" },
    { label = "Santo Tomé y Príncipe", id = "st" },
    { label = "Senegal", id = "sn" },
    { label = "Serbia", id = "rs" },
    { label = "Seychelles", id = "sc" },
    { label = "Sierra Leona", id = "sl" },
    { label = "Singapur", id = "sg" },
    { label = "Siria", id = "sy" },
    { label = "Somalia", id = "so" },
    { label = "Sri Lanka", id = "lk" },
    { label = "Sudán", id = "sd" },
    { label = "Sudán del Sur", id = "ss" },
    { label = "Suecia", id = "se" },
    { label = "Suiza", id = "ch" },
    { label = "Surinam", id = "sr" },
    { label = "Tailandia", id = "th" },
    { label = "Tanzania", id = "tz" },
    { label = "Tayikistán", id = "tj" },
    { label = "Timor Oriental", id = "tl" },
    { label = "Togo", id = "tg" },
    { label = "Tonga", id = "to" },
    { label = "Trinidad y Tobago", id = "tt" },
    { label = "Túnez", id = "tn" },
    { label = "Turkmenistán", id = "tm" },
    { label = "Turquía", id = "tr" },
    { label = "Tuvalu", id = "tv" },
    { label = "Ucrania", id = "ua" },
    { label = "Uganda", id = "ug" },
    { label = "Uruguay", id = "uy" },
    { label = "Uzbekistán", id = "uz" },
    { label = "Vanuatu", id = "vu" },
